...
class BaseFileProcessor(ABC):
    ...
    prefix = 'reporting_'
    reporting_schema_fields: List[SchemaField] = []
    ...
    def __init__(self, _s3_file_path: str, _incomingBucketName: str):
        ...
        print("report_type: ", self.report_type)
    ...
    def _set_properties_from_s3_path(self):
        ...
        self.report_type = extracted_data.get("report_type")
        ...
        self.start_date = DateHelper.convert_date_format(
            date_str=extracted_data.get("start_date"), original_format="%Y%m%d", target_format="%Y-%m-%d")
        self.end_date = DateHelper.convert_date_format(
            extracted_data.get("end_date"), original_format="%Y%m%d", target_format="%Y-%m-%d")
    ...
    def add_schema_field(cls, name: str, field_type: str):
        cls.reporting_schema_fields.append(SchemaField(name, field_type))

    @property
    def table_schema(self):
        return self.reporting_schema_fields
    ...
    def table_schema(self, fields_dict: Dict[str, str]):
        ...
        self.reporting_schema_fields.clear()
