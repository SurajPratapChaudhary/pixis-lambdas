...
class AdsApiReportProcessor(BaseFileProcessor):
    def __init__(self, s3_file_path: str, incoming_bucket_name: str):
        ...
        reportConfig = TableConfig(Constant.TBL_TYPE_REPORT, self.ad_type, self.report_type)
        self.schema = reportConfig.getSchema()
        self.load_method = reportConfig.getLoadMethod()
        self.dateFormats = reportConfig.getDateFormats()
        self.row_count = 0
    ...
    def clean_data(self) -> Tuple[bool, str, str]:
        ...
        for _encoding in encodings:
            try:
                ...
                if self.ad_type == 'SB' and self.report_type == 'campaign_v2':
    ...
    def load_csv_to_postgres(self, csv_file_path: str):
        ...
        """
        table_cfg = TableConfig(Constant.TBL_TYPE_REPORT, self.ad_type, self.report_type)
                ...
                if upload_success:
                    ...
                    if self.load_method == 'redis':
                        ...
                        if self.row_count > 0:
                            ...
                            loadDataToBQ = LoadDataToBigquery(
                                ...
                                report_filename=self.s3_file_path,
