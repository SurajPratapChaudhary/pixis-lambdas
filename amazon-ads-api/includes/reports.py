...
REPORTS = {
    Constant.ADTYPE_SP: {
        Constant.ADS_CAMPAIGN: {
            ...
            'clusterColumn': ['profileId', 'campaignId'],
            'indexColumns': [['profileId','date'],'date'],
            'loadMethod': 'merge',
        ...
        Constant.ADS_CAMPAIGN_PLACEMENT: {
            'partitionColumn': 'date',
            'clusterColumn': ['profileId', 'date'],
            'indexColumns': [['profileId','date'],'date'],
            'loadMethod': 'delete_insert',
            'mergeColumns': ['profileId','date'],
            'dataset': 'ads_sp',
            'tableName': 'reports_campaign_placement',
            'schema': {
                "marketplace": "STRING",
                "profileId": "STRING",
                "date": "TIMESTAMP",
        ...
        Constant.ADS_PURCHASED_PRODUCT: {
            ...
            'schema': {
                ...
                "purchases14d": "INT64",
                "purchases30d": "INT64",
                "purchasesOtherSku1d": "INT64",
                "purchasesOtherSku7d": "INT64",
                "purchasesOtherSku14d": "INT64",
                "purchasesOtherSku30d": "INT64",
                "unitsSoldClicks1d": "INT64",
                "unitsSoldClicks7d": "INT64",
                "unitsSoldClicks14d": "INT64",
                "unitsSoldClicks30d": "INT64",
                ...
                "sales14d": "FLOAT64",
                "sales30d": "FLOAT64",
                "salesOtherSku1d": "FLOAT64",
                "salesOtherSku7d": "FLOAT64",
                "salesOtherSku14d": "FLOAT64",
                "salesOtherSku30d": "FLOAT64",
                "unitsSoldOtherSku1d": "INT64",
                "unitsSoldOtherSku7d": "INT64",
                "unitsSoldOtherSku14d": "INT64",
                "unitsSoldOtherSku30d": "INT64",
                "kindleEditionNormalizedPagesRead14d": "INT64",
                "kindleEditionNormalizedPagesRoyalties14d": "INT64",
                "addToList": "INT64",
                "qualifiedBorrows": "INT64",
        ...
        Constant.ADS_SEARCH_TERM: {
            'partitionColumn': 'date',
            'indexColumns': [['profileId','date'],'date'],
            'loadMethod': 'delete_insert',
            'mergeColumns': ['profileId','date'],
            'dataset': 'ads_sp',
            'tableName': 'reports_search_term',
            'schema': {
                "marketplace": "STRING",
                "profileId": "STRING",
                "date": "TIMESTAMP",
    ...
    Constant.ADTYPE_SD: {
        ...
        Constant.ADS_ADGROUP: {
            ...
            'schema': {
                ...
                "kindleEditionNormalizedPagesRead": "INT64",
                "kindleEditionNormalizedPagesReadFromClicks": "INT64",
                "kindleEditionNormalizedPagesReadFromViews": "INT64",
                "kindleEditionNormalizedPagesRoyalties": "INT64",
                "kindleEditionNormalizedPagesRoyaltiesFromClicks": "INT64",
                "kindleEditionNormalizedPagesRoyaltiesFromViews": "INT64",
                "newToBrandPurchases": "INT64",
                "newToBrandPurchasesClicks": "INT64",
                "newToBrandSales": "FLOAT64",
                "newToBrandSalesClicks": "FLOAT64",
